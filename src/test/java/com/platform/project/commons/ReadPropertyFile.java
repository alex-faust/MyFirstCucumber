...
{
    private static Logger log = Logger.getLogger(ReadPropertyFile.class);
    ...
    private static String readFile(String file, String key)
    {
        ...
        try
        {
            ...
            log.info("Value in property file for " + key + " is " + value);
        } catch (IOException ioe){
            ioe.printStackTrace();
            log.info("Couldn't locate the property file");
        }
        return value;
    }
